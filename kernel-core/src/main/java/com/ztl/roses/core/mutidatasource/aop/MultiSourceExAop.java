package com.ztl.roses.core.mutidatasource.aop;

import com.ztl.roses.core.mutidatasource.DataSourceContextHolder;
import com.ztl.roses.core.mutidatasource.annotion.DataSource;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.ztl.roses.core.mutidatasource.annotion.DataSource)")
    private void cut() {
